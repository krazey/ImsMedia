...
public:
    ...
    void setRtpInactivityTimerMillis(const std::vector<int32_t>& times);
    const std::vector<int32_t>& getRtpInactivityTimerMillis() const;
    ...
    void setRtpPacketLossRate(const std::vector<int32_t>& rates);
    const std::vector<int32_t>& getRtpPacketLossRate() const;
    void setRtpJitterMillis(const std::vector<int32_t>& jitters);
    const std::vector<int32_t>& getRtpJitterMillis() const;
